...
export const ProductsProvider = ({ children }) => {
  ...
  const fetchSingleProducts = async (link) => {
  ...
  return <ProductsContext.Provider value={{ ...state, openSidebar, closeSidebar, fetchSingleProducts }}>{children}</ProductsContext.Provider>;
};
// make sure use
